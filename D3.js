...
for (let i = 0; i < starWarsCharacters.length; i++) {
  const charachter = starWarsCharacters[i];
  if (charachters.gender === 'female') {
    const femaleCharacter = {
      name: charachter.name,
      hair_color: charachter.hair_color,
      eyeColor: charachter.eye_color,
    };
...
case "red": eyeColor.blue.push(starWarsCharacters[i]);
break;
case "yellow": eyeColor.yellow.push(starWarsCharacters[i]);
break;
case "brown" : eyeColor.yellow.push(starWarsCharacters[i]);
break;
case "blue_gray" : eyeColor.yellow.push(starWarsCharacters[i]);
break;
case "blue" : eyeColor.yellow.push(starWarsCharacters[i]);
